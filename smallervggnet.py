...
class SmallerVGGNet:
    ...
    def build(width, height, depth, classes):
        ...
        model.add(MaxPooling2D(pool_size=(3, 3)))         #use a 3x3 pool size to reduce spatial dimensions quickly from 96x96 down to 32x32
        ...
        model.add(Flatten())
        model.add(Dense(1024, input_shape=(27648,)))
        model.add(Activation("relu"))
